            ...
            <div className="skills">
                <div className="container">
                    <div className="skills__inner">
                        <div className="skills__title">What makes our brand different</div>
                        <div className="skills__items">
                            <div className="skills__item item-skills">
                                <div className="item-skills__icon">
                                ...
                                <div className="item-skills__title">Next day as standard</div>
                            ...
                            <div className="skills__item item-skills">
                                ...
                                <div className="item-skills__title">Made by true artisans</div>
                                <div className="item-skills__text">
                            ...
                            <div className="skills__item item-skills">
                                ...
                                <div className="item-skills__title">Unbeatable prices</div>
                                <div className="item-skills__text">
                            ...
                            <div className="skills__item item-skills">
                                ...
                                <div className="item-skills__title">Recycled packaging</div>
                                <div className="item-skills__text">
